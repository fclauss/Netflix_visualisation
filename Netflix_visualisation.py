...
# The year 2017 is represented in all 3 datas
...
# The Stocks data is represented by months, the quarterly data is represented by working days
# The quarterly data has more rows. The 2 Stocks data are identical, except for the price values
# The data have the same columns. The quarterly data has an additional column for the Quarter
...
#plt.show()
plt.savefig("Earning_and_revenue.png")
...
# Revenue and Earnings follow an upwards trend
# Earnings represent roughly 2-8% of the Revenue
